            ...
            console.log(r);
                ...
                orders.forEach(ord => { //forEach start
                    html +=   `
                        ...
                        <th> ${ord.coupname} </th>
                        <th> <button type="button" class="cancelButton" onclick="Cancelcheck(${ord.orddetailcode})"> 취소확정 </button> </th>
                        </tr>`
                        }); //forEach end
                        }; //if end
                //목록 출력
...
//취소 확정 함수
function Cancelcheck(orddetailcode){console.log('Cancelcheck()')
